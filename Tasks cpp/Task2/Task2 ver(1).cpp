//CODE WORKS PERFECTLY, BUT IS NOT AN ACCEPTABLE SOLUTION TO THE TASK DUE TO SEPARATING THE INPUT STRINGS OF TYPE AND DESCRIPTION, AND THE CONSTRAINT; ASSUMING A MAX OF 100 RESISTORS
#include <iostream>
#include <string>
using namespace std;
